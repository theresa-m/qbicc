...
// $ jbang org.qbicc:qbicc-main:0.4.0-SNAPSHOT --boot-path-append-file $(jbang info classpath examples/helloworld/hello/world/Main.java) --output-path /tmp/output hello.world.Main
//
// Run the executable
// $ /tmp/output/a.out
//
